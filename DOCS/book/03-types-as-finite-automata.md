...
This derivation tree corresponds to the value generated by the constant function `{ {} |true head, {} |nil tail } |cons`.
...
Canonical Form: $C0=<C0"0",C0"1",C1"_">;$C1={}
     ...
     Hash
      ↓
Identifier: @VtPHxGf5GNMzzyVFxtv7gegFfJRYapBGtCeyV56bs5Zb
```
